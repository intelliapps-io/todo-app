...
export const javascriptDateToSQLDate = (date: Date) => date.toISOString().replace('T', ' ').replace('Z', '').substring(0, date.toISOString().length - 5)
export const javascriptDateToSQLDateYMD = (date: Date) => date.toISOString().replace('T', ' ').replace('Z', '').substring(0, date.toISOString().length - 14)
